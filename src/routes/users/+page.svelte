<script lang="ts">
    ...
    let showModal = false;
    let searchQuery = '';  // Declare this variable
  ...
  <div class="p-6 max-w-6xl mx-auto">
    ...
    <div class="flex justify-between space-x-2 mb-4">
      <input
        ...
        class="px-4 py-2 border rounded-lg w-60"
      />
    ...
    {:else if users.length === 0}
      <p>Loading...</p>
    {:else}
    <div class="overflow-x-auto rounded border max-w-full border-gray-300">
          ...
          {#each filteredUsers as user}
            <tr class="border-t border-gray-300 hover:bg-gray-100">
              ...
              <td class="p-3 flex space-x-2">
                ...
                >
                  <i class="fa-solid fa-trash-can-arrow-up w-5 h-5"></i>
                </button>
      ...
      <button on:click={() => goto('/')} class="mb-4 text-blue-600 mt-4 hover:text-red-500">
        ← Back to Home
      </button>
    {/if}
    ...
    <!-- MODAL -->
    {#if showModal}
      <div class="fixed inset-0 bg-black/50 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white p-4 sm:p-6 rounded-lg w-full max-w-sm sm:max-w-md shadow-lg mx-2 border border-gray-300">
